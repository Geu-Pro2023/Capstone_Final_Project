  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (mounted && user != null) {
        ...
        if (mounted) _showErrorDialog('Invalid email or password');
      }
    } catch (e) {
      if (mounted) _showErrorDialog('Login failed: ${e.toString()}');
    } finally {
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      if (mounted && user != null) {
        ...
        if (mounted) _showErrorDialog('Google sign-in was cancelled');
      }
    } catch (e) {
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: AppTheme.userColor.withOpacity(0.1),
